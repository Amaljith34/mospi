...
const Key_Aggregates_National_Account = () => {
  ...
  const stats = [
    { icon: <FaChartBar className="text-yellow-400 text-2xl" />, value: "Key aggregates of national account  (in crore) for2011-12 to 2021-22", label: "Total Sales", change: "+10% from yesterday", color: "text-yellow-400", path: "/kana1" },
    ...
    { icon: <FaChartBar className="text-neutral-600 text-2xl" />, value: "Exports of goods and services ", label: "Exports of goods and services ", change: "+2% from yesterday", color: "text-pink-400", path: "/kana3" },
    ...
    { icon: <FaChartBar className="text-neutral-600 text-2xl" />, value: "Imports of goods and services ", label: "Imports of goods and services at constant price", change: "+2% from yesterday", color: "text-pink-400", path: "/kana5" },
    ...
    { icon: <FaChartBar className="text-neutral-600 text-2xl" />, value: "Imports and Exports of goods and services ", label: "Imports and Exports of goods and services at current price", change: "+2% from yesterday", color: "text-pink-400", path: "/kana7" },
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl font-semibold">Key Aggregates National Account</h2>
